...
import com.aliyun.dc.opplat.sdk.api.internal.codec.Base64;
import com.aliyun.dc.opplat.sdk.api.internal.util.StreamUtil;
import com.aliyun.dc.opplat.sdk.api.utils.StringUtils;

/**
 * RSA算法加密器 签名部分采用SHA1算法进行摘要计算
 * @author changlei.qcl
 * @version $Id: RSAEncryptor.java, v 0.1 2020年07月27日 8:31 PM changlei.qcl Exp $
 */
public class RSAEncryptor extends BaseAsymmetricEncryptor {
    ...
    protected String getSignAlgorithm() {
        return OpplatConstants.SIGN_ALGORITHMS;
    }

    @Override
    protected String getAsymmetricType() {
        return OpplatConstants.SIGN_TYPE_RSA;
    }
    ...
    protected String doDecrypt(String cipherTextBase64, String charset, String privateKey) throws Exception {
        ...
        PrivateKey priKey = getPrivateKeyFromPKCS8(OpplatConstants.SIGN_TYPE_RSA,
                new ByteArrayInputStream(privateKey.getBytes()));
        Cipher cipher = Cipher.getInstance(OpplatConstants.SIGN_TYPE_RSA);
    ...
    protected String doEncrypt(String plainText, String charset, String publicKey) throws Exception {
        ...
        PublicKey pubKey = getPublicKeyFromX509(OpplatConstants.SIGN_TYPE_RSA,
